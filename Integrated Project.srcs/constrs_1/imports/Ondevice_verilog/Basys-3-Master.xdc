...
## Switches (sw[3:0] 사용, reset은 sw[15] 사용)
...
##7 Segment Display (fnd_data[6:0]은 a~g, fnd_data[7]은 dp)
...
#set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports echo_pin];#Sch name = JA9
#set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports trig_pin];#Sch name = JA10
